...
import static com.felipeferreiradasilva.domain.MetaAsserts.*;
import static com.felipeferreiradasilva.web.rest.TestUtil.createUpdateProxyForBean;
...
class MetaResourceIT {
    ...
    private static final AreaEnem DEFAULT_AREA = AreaEnem.LINGUAGENS_CODIGOS;
    private static final AreaEnem UPDATED_AREA = AreaEnem.CIENCIAS_HUMANAS;
    ...
    public static Meta createEntity(EntityManager em) {
        Meta meta = new Meta().area(DEFAULT_AREA).pontuacao(DEFAULT_PONTUACAO);
        // Add required entity
        Aluno aluno;
    ...
    public static Meta createUpdatedEntity(EntityManager em) {
        Meta updatedMeta = new Meta().area(UPDATED_AREA).pontuacao(UPDATED_PONTUACAO);
        // Add required entity
        Aluno aluno;
        if (TestUtil.findAll(em, Aluno.class).isEmpty()) {
    ...
    void putExistingMeta() throws Exception {
        ...
        updatedMeta.area(UPDATED_AREA).pontuacao(UPDATED_PONTUACAO);
    ...
    void fullUpdateMetaWithPatch() throws Exception {
        ...
        partialUpdatedMeta.area(UPDATED_AREA).pontuacao(UPDATED_PONTUACAO);
